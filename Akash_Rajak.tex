...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Software Developer - Intern}}{Exposys Data Labs}{-\tob Project\tob :\tob Built an algorithm to secure messages with high security and with efficient time. And also authenticated user entity.}{\tob  JUL 2021 - Aug 2021\tob (1 mos)}
        \end{itemize}
        \begin{itemize}
            \item \frcontent{\textcolor{black}{LGM SOC'21 - Open Source Contributor}}{Lets Grow More}{-\tob Contributed to different opensource projects.}{\tob  JUN 2021 - AUG 2021\tob (3 mos)}
        \end{itemize}
    }
