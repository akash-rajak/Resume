...
% left side %
{
	...
	\csection{\textcolor{turkishgreen}{SKILLS}}{\small
        \begin{itemize}
            ...
            {\footnotesize - \tob C,\tob C++,\tob Java,\tob Python,\tob HTML-CSS,\tob SQL, PL SQL, Algorithms \& Data Structure \newline - Dev C++, Pycharm, Jupiter Notebook, Eclipse, MySQL,\tob Android Studio,\tob Scilab,\tob Qtspim, Git \& Github}{}{}
            \vspace{-2 mm}
            \item \textbf{\textcolor{black}{Patterns \tob\&\tob Practices}} \newline
            {\footnotesize Problem Solving,\tob OS,\tob DBMS,\tob ML/DL/NLP Model Creation}{}{}
            \vspace{-2 mm}
...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{PROJECTS}}{\small
        \begin{itemize}
            % PROJECT - 1 ----------------
            \item \frcontent{\textcolor{black}{CaveMan\tob -\tob The\tob Saviour} \clink{\href{https://github.com/akash-rajak/CaveMan-The_Saviour}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob A 2D physics - based flash game app created using ANDROID STUDIO and with simple graphics.}{}{+\tob Features used - Java, Android Studio, Sqlite database}
            \vspace{-2 mm}
			% PROJECT - 2 ----------------
            \item \frcontent{\textcolor{black}{Real Time Human Detection \& Counting} \clink{\href{https://github.com/akash-rajak/Real-Time-Human-Detection-Counting}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob A Python script to detect and count humans in real time images, videos \& through camera.}{}{+\tob Features used - Python (Tensorflow, OpenCv, matplotlib), Deep Learning}            
            ...
            \vspace{-2 mm}
            % PROJECT - 3 ----------------
            \item \frcontent{\textcolor{black}{Video Stitching} \clink{\href{https://github.com/akash-rajak/Video-Stitching}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob Built a Video Stitching application with ROW and COLUMN STITCHING.}{}{+\tob Features used - Python (tkinter, opencv, moviepy, PIL)}
            \vspace{-2 mm}
            % PROJECT - 4 ----------------
            \item \frcontent{\textcolor{black}{Dictionary} \clink{\href{https://github.com/akash-rajak/Dictionary}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob Built an English dictionary with AUTO-COMPLETE, TEXT - SPEECH, SPEECH - TEXT, VIRTUAL KEYPAD feature.}{}{+\tob Features used - Python (tkinter, pyttsx3, speech recognition, pyaudio)}
            \vspace{-2 mm}
            % PROJECT - 5 ----------------
    ...
    \csection{\textcolor{turkishgreen}{Certifications \& Awards}}{\small
    	\begin{itemize}
            \item {\footnotesize Participated in 30 Days of Google Cloud and completed both Cloud Engineering Track and Data Science \& Machine Learning Track.}
            \vspace{-2 mm}
            \item 
            \clink{
...
% left side %
{
    ...
    \csection{\textcolor{turkishgreen}{COURSES}}{\small
        \begin{itemize}
            ...
            {\footnotesize Programming with C, DSA, Algorithm Analysis \& Design, Computer Architecture, Formal Language \& Automata Theory, Data Science (Python), OS, Object Oriented Programming (JAVA), Scilab, Qtspim, Compiler Design, AI, ML, DBMS, Computer Network}
            \vspace{-2 mm}
            ...
            {\footnotesize Physics, Ethics, Economics, Humanity (Psychology), Cognitive Science, Soft Skill Development}
        \end{itemize}
    }
    ...
    \csection{\textcolor{turkishgreen}{Interests \& Hobbies}}{\small
        \begin{itemize}
            ...
            \vspace{-2 mm}
            \item {\footnotesize Open Sourcing}
            \vspace{-2 mm}
            \item {\footnotesize Reading \& Writing}
        \end{itemize}
    }
...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{Events \& Participations}}{\small
        \begin{itemize}
            ...
            \vspace{-2 mm}
            \item {\footnotesize Participated \& Contributed to Open Source programs like HacktoberFest'21, LGM SOC'21, GDSC IIIT Kalyani WOC, GWOC'21, SWOC'21.}
            \vspace{-2 mm}
