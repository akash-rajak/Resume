...
% left side %
{
    ...
    %\csection{\textcolor{turkishgreen}{}}{\small
    	\vspace{-8 mm}
        \small \begin{itemize}
            \item \frcontent{\textcolor{black}{Winter Of Code'21 - Student Member}}{Google Developer Student Club - IIIT Kalyani}{-\tob Project\tob :\tob Tabular ML (Built an end-to-end ML system for tabular datasets).}{\tob  JAN 2021 - MAR 2021\tob (3 mos)}
        \end{itemize}
    %}
	...
	\csection{\textcolor{turkishgreen}{SKILLS}}{\small
        \begin{itemize}
            ...
            {\footnotesize - \tob C, C++, Java, Python, HTML-CSS, SQL \newline - \tob Dev C++, Pycharm, Jupiter Notebook, Eclipse, MySQL, Android Studio, Scilab, Qtspim, Git \& Github}{}{}
            \vspace{-2 mm}
...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{Certifications \& Awards}}{\small
    	\begin{itemize}
        	...
        	\item
        	\clink{
        	\href{https://drive.google.com/file/d/1vCJ76cxaN2opM3A4hDm1Ce8pCaPhWweI/view?usp=sharing}{\textcolor{turkishgreen}{\underline{3rd Runner Up - AlgoUniversity CodeRush}}}
        }
        	\vspace{-2 mm}
        	\item 
            \clink{
...
% left side %
{
    ...
    \csection{\textcolor{turkishgreen}{COURSES}}{\small
        \begin{itemize}
            ...
            {\footnotesize Programming with C, DSA, Algorithm Analysis \& Design, Computer Architecture, Formal Language \& Automata Theory, Data Science (Python), Operating System, Object Oriented Programming (JAVA), Scilab, Qtspim, Compiler Design, AI, ML, DBMS, Computer Network}
            \vspace{-2 mm}
