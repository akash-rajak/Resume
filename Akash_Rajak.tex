...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Software Developer - Intern}}{Exposys Data Labs}{-\tob Project\tob :\tob Built an algorithm to secure chat messages with high security and with efficient time.}{\tob  JUL 2021 - Aug 2021\tob (1 mos)}
        \end{itemize}
        \vspace{-8 mm}
        \begin{itemize}
    ...
    %\csection{\textcolor{turkishgreen}{}}{\small
    	\vspace{-8 mm}
        \small \begin{itemize}
            \item \frcontent{\textcolor{black}{Winter Of Code'21 - Student Member}}{Google Developer Student Club - IIIT Kalyani}{-\tob Project\tob :\tob Tabular ML (Built an end-to-end ML system for tabular datasets and handled large datasets using tabular ML model).}{\tob  JAN 2021 - MAR 2021\tob (3 mos)}
        \end{itemize}
    %}
...
% right side %
{
	...
	\csection{\textcolor{turkishgreen}{LINKS}}{\small
        \begin{itemize}
            \item 
            \clink{
        	\href{https://github.com/akash435}{\textcolor{turkishgreen}{\includegraphics[width=0.4cm]{images/github.png}\tob   \underline{Github}}}
        	\textbf{} 
        	\href{https://www.linkedin.com/in/akash-rajak-akash435/}{\textcolor{turkishgreen}{\includegraphics[width=0.4cm]{images/linkedin.png}\tob \underline{Linkedin}}}
        	\textbf{}
        	\href{https://www.hackerrank.com/aakashrajak02?hr_r=1}{\textcolor{turkishgreen}{\includegraphics[width=0.4cm]{images/hackerrank.png}\tob \underline{HackerRank}}}
        }
        \end{itemize}
        \vspace{-5 mm}
        \begin{itemize}
        	...
        	\textbf{}
        	\href{https://leetcode.com/akash435/}{\textcolor{turkishgreen}{\includegraphics[width=0.4cm]{images/leetcode.png}\tob \underline{LeetCode}}}
            %\newline
        }
        \end{itemize}
    }
