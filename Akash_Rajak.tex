...
% left side %
{
    ...
    \csection{\textcolor{turkishgreen}{COURSES}}{\small
        \begin{itemize}
            ...
            {\footnotesize Programming with C, Data Structures \& Algorithm, Algorithm Analysis \& Design, Computer Architecture, Formal Language \& Automata Theory, Data Science (Python), Operating System, Object Oriented Programming (JAVA), Scilab, Qtspim, Compiler Design, AI, ML, DBMS, Computer Network}
    ...
    \csection{\textcolor{turkishgreen}{Interests \& Hobbies}}{\small
        \begin{itemize}
            ...
            \item {\footnotesize Reading\tab \textbf{•} \tob Writing}
        \end{itemize}
    }
