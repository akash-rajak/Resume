...
% left side %
{
	...
	\csection{\textcolor{turkishgreen}{SKILLS}}{\small
        \begin{itemize}
            ...
            {\footnotesize - \tob C,\tob C++,\tob Java,\tob Python,\tob HTML-CSS,\tob SQL, PL SQL, JavaScript, Algorithms \& Data Structure \newline - Dev C++, Pycharm, Jupiter Notebook, Eclipse, MySQL,\tob Android Studio,\tob Scilab,\tob Qtspim, Git \& Github}{}{}
            \vspace{-2 mm}
...
% left side %
{
    ...
    \csection{\textcolor{turkishgreen}{COURSES}}{\small
        \begin{itemize}
            ...
            {\footnotesize DSA, Algorithm Analysis \& Design, Computer Architecture, Formal Language \& Automata Theory, Data Science, OS, Object Oriented Programming, Scilab, Qtspim, Compiler Design, AI, ML, NLP, DBMS, Computer Network}
            \vspace{-2 mm}
            \item \textbf{\textcolor{black}{Electronics}} \newline
            {\footnotesize Digital Electronics, Analog Electronics, Data Communication, Signals \& Systems, Microprocessor \& Microcontroller System, Quantum Computing}
            \vspace{-2 mm}
