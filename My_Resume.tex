...
% right side %
{
    ...
    \csection{\textcolor{blue}{PROJECTS}}{\small
        \begin{itemize}
            ...
            % PROJECT - 2 ----------------
            \item \frcontent{\textcolor{violet}{PasswordStrengthPredictor} \clink{\href{https://github.com/akash435/Password-Strength-Predictor}{\tob \textcolor{cyan}{\underline{[Github\tob Link]}}}}}{-\tob Made a NLP and ML model, to predict the strength of passwords, which are given in csv dataset.}{-\tob Used nltk library for for NLP and numpy, pandas module for preprocessing purpose.}{+\tob Features used - Python(numpy, pandas, seaborn library), Logistic Regression, Jupiter Notebook}
            
            % PROJECT - 3 ----------------
            \item \frcontent{\textcolor{violet}{Tabular-ML} \clink{\href{https://github.com/akash435/Tabular-ML}{\tob \textcolor{cyan}{\underline{[Github\tob Link]}}}}}{-\tob Built an end-to-end ML system for tabular datasets.}{-\tob Took a sample titanic event dataset and from the tabular dataset predicted the how many childrens,, mens, womens, captains, etc. got rescued and how many died and injured.\newline -\tob Used the Python packages like numpy, random, pandas, seaborn, matplotlib.pyplot, etc. and we accordingly trained the data and tested also.}{+\tob Features used - Python, Jupiter Notebook}
        \end{itemize}
    }
