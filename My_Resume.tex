...
% right side %
{
    ...
    \csection{\textcolor{blue}{PROJECTS}}{\small
        \begin{itemize}
            ...
            % PROJECT - 3 ----------------
            \item \frcontent{\textcolor{violet}{Dictionary} \clink{\href{https://github.com/akash435/Dictionary}{\tob \textcolor{cyan}{\underline{[Github\tob Link]}}}}}{-\tob Built an English dictionary.\newline -\tob Implemented the AUTO-COMPLETE feature.\newline -\tob Implemented TEXT - SPEECH \tob\&\tob SPEECH - TEXT.\newline -\tob Added VIRTUAL KEYPAD.}{-\tob For data set, used JSON \& CSV data file.\newline -\tob Also implemented the case of word having interfaces (many meanings) and in case of any typo, developed the closest word matching technique.}{+\tob Features used - Python (tkinter, pyttsx3, speech recognition, pyaudio)}
