...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Software Developer - Intern}}{Exposys Data Labs}{-\tob Project\tob :\tob Built an alogorithm to secure messages with high security and less time. And also authenticated user entity.}{\tob  JUL 2021 - Aug 2021\tob (1 mos)}
        \end{itemize}
        \begin{itemize}
