...
% right side %
{
    ...
    \csection{\textcolor{blue}{PROJECTS}}{\small
        \begin{itemize}
            ...
            % PROJECT - 2 ----------------
            \item \frcontent{\textcolor{violet}{PasswordStrengthPredictor} \clink{\href{https://github.com/akash435/Password-Strength-Predictor}{\tob \textcolor{cyan}{\underline{[Github\tob Link]}}}}}{-\tob Made a NLP and ML model, to predict the strength of passwords, using csv dataset.}{-\tob Used nltk library for for NLP and numpy, pandas module for preprocessing purpose.}{+\tob Features used - Python(numpy, pandas, seaborn library), Logistic Regression, Jupiter Notebook}
