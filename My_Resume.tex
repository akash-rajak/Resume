...
\begin{tabularx}{\linewidth}{@{}m{0.8\textwidth} m{0.2\textwidth}@{}}
{
    ...
    \small{
        ...
        \textcolor{violet}{Gujarat, India - 391410}
    }
}
% ------------------------------------------------------------------
...
% left side %
{
	...
	\csection{\textcolor{blue}{SKILLS}}{\small
        \begin{itemize}
            ...
            {\footnotesize C, C++, Java, Python, HTML, CSS, Scilab, MIPS Assembly Language}{}{}
            \item \textbf{\textcolor{violet}{Technologies}} \newline
            {\footnotesize Dev C++, Pycharm, Jupiter Notebook, Eclipse,  Android Studio, Scilab, Qtspim, Git \& Github}{}{}
            \item \textbf{\textcolor{violet}{Patterns \& Practices}} \newline
            {\footnotesize Object Oriented Programming, Competitive Programming, Machine Learning, Python (Django)}
    ...
    \csection{\textcolor{blue}{Certifications \& Awards}}{\small
        \begin{itemize}
            \item 
            \clink{
        	\href{https://drive.google.com/file/d/10sXwmb6wxSuvKRxmuy-zUPSzIliKLoce/view}{\textcolor{cyan}{\underline{Code Kaze'21 - Certificate}}}
        }
        \end{itemize}
        ...
        \begin{itemize}
            \item 
            \clink{
        	\href{https://drive.google.com/file/d/1yKLWfopv5k2C1YMbC8GmZNl1wXWj2vXq/view}{\textcolor{cyan}{\underline{Code Frenzy - Certificate}}}
        }
        \end{itemize}
        ...
        \begin{itemize}
            \item 
            \clink{
        	\href{https://drive.google.com/file/d/11pssUHnwQSHhpv3muc3RsOlsujGNo9Zt/view}{\textcolor{cyan}{\underline{Android Study Jam - Certificate}}}
        }
        \end{itemize}
        ...
        \begin{itemize}
            \item 
            \clink{
        	\href{https://drive.google.com/file/d/1LdR-E4uXdbXYD3yLiHGOtKpeYbjZcNo6/view}{\textcolor{cyan}{\underline{Winter Of Code - Certificate}}}
        }
        \end{itemize}
    }
