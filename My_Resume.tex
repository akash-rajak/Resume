...
% left side %
{
    ...
    %\csection{\textcolor{turkishgreen}{}}{\small
        \small \begin{itemize}
            \item \frcontent{\textcolor{black}{Winter Of Code'21 - Student Member}}{Developer Student Club - IIIT Kalyani}{-\tob Project\tob :\tob Tabular ML (Built an end-to-end ML system for tabular datasets).}{\tob  JAN 2021 - MAR 2021\tob (3 mos)}
        \end{itemize}
    %}
