...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{PROJECTS}}{\small
        \begin{itemize}
            % PROJECT - 1 ----------------
			\item \frcontent{\textcolor{black}{Power Bi Automation} \clink{\href{https://github.com/akash-rajak/Power-BI-Automation}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob Python based automation tool to automate the Power Bi Model or Report documenter using Open AI API.}{}{+\tob Features - Python, Power Bi}            
