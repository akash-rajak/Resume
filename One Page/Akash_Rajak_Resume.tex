...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
        ...
        \end{itemize}
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Software Developer Intern}}{Exposys Data Labs}{-\tob Project\tob :\tob Built an algorithm to secure chat messages with 95\% high security and with 2x efficient time.}{\tob  JUL 2021 - Aug 2021\tob (1 mos)}
        \end{itemize}
        %\vspace{-8 mm}
        %\begin{itemize}
