...
% left side %
{
	...
	\csection{\textcolor{turkishgreen}{SKILLS}}{\small
        \begin{itemize}
            ...
            {\footnotesize - \tob Java, Spring Framework, Spring Boot, Python, C\#, JavaScript, HTML-CSS, Azure, Git \& Github, C++}{}{}
            \vspace{-2 mm}
...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{PROJECTS}}{\small
        \begin{itemize}
            ...
            \vspace{-1 mm}
			% PROJECT - 2 ----------------
            \item \frcontent{\textcolor{black}{Real Time Human Detection \& Counting} \clink{\href{https://github.com/akash-rajak/Real-Time-Human-Detection-Counting}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob A tensorflow based Faster RCNN inception v2 python model to detect and count humans in real time images, videos \& camera.}{}{+\tob Features - Python, Tensorflow, RCNN, Deep Learning}            
