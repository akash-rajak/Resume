...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{PROJECTS}}{\small
        \begin{itemize}
            % PROJECT - 1 ----------------
            \item \frcontent{\textcolor{black}{Fitness Tracker} \clink{\href{https://github.com/akash-rajak/Fitness-Tracker}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob A Python based Software Engineering model to track fitness implemented using Iterative Waterfall Software Development Life Cycle Model.}{}{+\tob Features - Python, SDLC, Iterative Waterfall Model}
