...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
   		\begin{itemize}
            \item \frcontent{\textcolor{black}{Associate Software Engineer}}{MAQ Software}{-\tob Project\tob :\tob Currently doing training on Power Bi and Azure Devops.}{\tob  Feb 2023 - Present}
        \end{itemize}
        \begin{itemize}
