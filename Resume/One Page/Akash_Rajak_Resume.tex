...
% left side %
{
    ...
    % -------- EXPERIENCE PART ----------------------------------
   	\csection{\textcolor{turkishgreen}{EXPERIENCE}}{\small
   		\begin{itemize}
   		\vspace{-2 mm}
            \item \frcontent{\textcolor{black}{Associate Software Engineer}}{MAQ Software \tab\tab\tab Feb 2023 - Present}{-\tob Project\tob :\tob Worked on automating Power Bi Documentation and generating STTM Test Cases using Open AI API. Currently working on Automation Migration Tool Project under Pepsico Team.}{}
        \end{itemize}
        \vspace{-13.5 mm}
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Chegg Q\&A Expert}}{Chegg India \tab\tab Sep 2022 - Jan 2023\tob (5 mos)}{-\tob Worked as Problem Solver in Computer Science Domain on Chegg Expert site.}{}
        \end{itemize}
        \vspace{-13 mm}
        \begin{itemize}
            \item \frcontent{\textcolor{black}{Software Developer Intern}}{Exposys Data Labs \tab Jul 2021 - Aug 2021\tob (1 mo)}{-\tob Project\tob :\tob Worked on updating the Cryptography RSA algorithm to secure chat messages with 95\% high accuracy on security and with 2x efficient time.}{}
        \end{itemize}
        \vspace{-6 mm}
        %\begin{itemize}
	...
	\csection{\textcolor{turkishgreen}{SKILLS}}{\small
        ...
        \vspace{-2 mm}
            ...
            {\footnotesize - \tob Java, Spring Framework, Spring Boot, ReactJS, NodeJS, Python, C\#, JavaScript, HTML-CSS, Azure, Git \& Github, C++}{}{}
            \vspace{-2 mm}
...
% right side %
{
    ...
    \csection{\textcolor{turkishgreen}{PROJECTS}}{\small
        \begin{itemize}
            % PROJECT - 1 ----------------
            \vspace{-1 mm}
            \item \frcontent{\textcolor{black}{Pretty JSON Viewer} \clink{\href{https://github.com/akash-rajak/Pretty-JSON-Viewer}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob Designed and developed a clean and modern react app using \textbf{React.js , HTML, CSS, and JavaScript}.\newline -\tob  Implemented the JSON file selecting option using \textbf{File Handler}, along with \textbf{Copy Action} button. \newline -\tob Utilized \textbf{responsive design} to ensure compatibility across all devices.}{}{+\tob Features - ReactJS, JavaScript, HTML, CSS, JSON}
			%\item \frcontent{\textcolor{black}{Power Bi Automation} \clink{\href{https://github.com/akash-rajak/Power-BI-Automation}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob Python package integrated with Power Bi to automate the extraction of Measures and its Description, Source Information and the Relationships details from Power Bi Report using Open AI API.}{}{+\tob Features - Python, Power Bi, OpenAI, openpyxl}            
            \vspace{-1 mm}
            ...
            \vspace{-2 mm}
			% PROJECT - 2 ----------------
            \item \frcontent{\textcolor{black}{Real Time Human Detection \& Counting} \clink{\href{https://github.com/akash-rajak/Real-Time-Human-Detection-Counting}{\tob \textcolor{turkishgreen}{\underline{[Github\tob Link]}}}}}{-\tob A tensorflow based \textbf{Faster RCNN inception v2} python model to detect and count humans in real time images, videos \& camera. \newline - \tob Used pre-trained \textbf{frozen\_inference\_graph.pb} frozen graph to handle the detection.}{}{+\tob Features - Python, Tensorflow, RCNN, XML, Git}            
    ...
    \csection{\textcolor{turkishgreen}{Certifications \& Awards}}{\small
        ...
        %}
       	...
       	%}
       		...
       		\item
        	\clink{
        	\href{https://www.linkedin.com/learning/certificates/63e86e0d8c71c78ed15b6b0b262224c12561c1fa962ce7e113e4b96dc6366934}{\textcolor{turkishgreen}{\underline{Python Automation and Testing}}}
        }
        	\vspace{-1.5 mm}
       		\item
        	\clink{
